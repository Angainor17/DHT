...
public class StringMap extends java.util.AbstractMap<String, String> {
    ...
    public StringMap(StringMap other) {
        this(RingserviceJNI.new_StringMap__SWIG_1(StringMap.getCPtr(other), other), true);
    }
    ...
    static protected class Iterator {
        ...
        public synchronized void delete() {
            if (swigCPtr != 0) {
                if (swigCMemOwn) {
                    swigCMemOwn = false;
                    RingserviceJNI.delete_StringMap_Iterator(swigCPtr);
                }
                swigCPtr = 0;
            }
        }
        ...
        private StringMap.Iterator getNextUnchecked() {
            return new StringMap.Iterator(RingserviceJNI.StringMap_Iterator_getNextUnchecked(swigCPtr, this), true);
        }

        private boolean isNot(StringMap.Iterator other) {
            return RingserviceJNI.StringMap_Iterator_isNot(swigCPtr, this, StringMap.Iterator.getCPtr(other), other);
        }

        private String getKey() {
            return RingserviceJNI.StringMap_Iterator_getKey(swigCPtr, this);
        }

        private String getValue() {
            return RingserviceJNI.StringMap_Iterator_getValue(swigCPtr, this);
        }

        private void setValue(String newValue) {
            RingserviceJNI.StringMap_Iterator_setValue(swigCPtr, this, newValue);
        }

    }

    public boolean isEmpty() {
        return RingserviceJNI.StringMap_isEmpty(swigCPtr, this);
    }
    ...
    private StringMap.Iterator find(String key) {
        return new StringMap.Iterator(RingserviceJNI.StringMap_find(swigCPtr, this, key), true);
    }

    private StringMap.Iterator begin() {
        return new StringMap.Iterator(RingserviceJNI.StringMap_begin(swigCPtr, this), true);
    }

    private StringMap.Iterator end() {
        return new StringMap.Iterator(RingserviceJNI.StringMap_end(swigCPtr, this), true);
    }

    private int sizeImpl() {
        return RingserviceJNI.StringMap_sizeImpl(swigCPtr, this);
    }

    private boolean containsImpl(String key) {
        return RingserviceJNI.StringMap_containsImpl(swigCPtr, this, key);
    }

    private void putUnchecked(String key, String value) {
        RingserviceJNI.StringMap_putUnchecked(swigCPtr, this, key, value);
    }

    private void removeUnchecked(StringMap.Iterator itr) {
        RingserviceJNI.StringMap_removeUnchecked(swigCPtr, this, StringMap.Iterator.getCPtr(itr), itr);
    }
